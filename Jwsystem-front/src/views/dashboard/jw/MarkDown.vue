    ...
    methods: {
      save() {
        ...
        if (this.program != null && this.program != "") {
          this.program['content'] = this.$refs.md._data['d_value']
          this.program['htmlContent'] = this.$refs.md._data['d_render']
          notice.edit(this.program).then(res => {
            if (res) {
              this.$message({
                type: "success",
                message: "成功"
          ...
          notice.edit(this.form).then(res => {
            if (res) {
              this.$message({
                type: "success",
                message: "成功"
